  ...
  return (
    <div className="flex flex-col justify-center text-center xl:text-left">
      ...
      <p className="text-lg md:text-xl text-slate-500 mb-6 md:mb-8 max-w-lg mx-auto xl:mx-0 leading-relaxed">
        A friendly dead man's switch ensuring your digital assets reach your loved ones or backup wallets in the event of a loss of life or hardware. Simple, secure, automatic.
      </p>
